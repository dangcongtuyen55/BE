...
exports.getAllProductsDisplay = async (req, res, next) => {
  try {
    const products = await Product.find()
      ...
      .select(
        "name price  description rating offer stock reviews createBy product_url createdAt isDeleted category"
      );
    res.status(200).json({
      status: "success",
...
exports.getProductDetail = async (req, res, next) => {
  try {
    ...
    //   "_id rating  reviews name category description price stock product_url"
    // );
    // res.status(200).json({
    //   success: true,
    //   product,
...
//       .select(
//         "name slug price  description rating offer stock reviews createBy product_url createdAt isDeleted category"
//       );
//     res.status(200).json({
//       status: "success",
//       results: products.length,
...
//     const categories = await Category.find();
//     const product = await Product.findById(id).select(
//       "_id name category description price stock product_url"
//     );
...
//     const categories = await Category.find();
//     const products = await Product.find()
//       .select("_id name category product_url price description")
//       .populate("category");
